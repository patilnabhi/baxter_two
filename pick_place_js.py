...
def start_robot():
    ...
    ik = baxter_kinematics("right")
    joints = ['right_e0', 'right_e1', 'right_s0', 'right_s1', 'right_w0', 'right_w1', 'right_w2']
    joint_pos = ik.inverse_kinematics([0.6, -0.2, 0.6], [1,0,0,0])
    g.moveToJointPosition(joints,joint_pos)
